    ...
    <div class="placeholder-grid">
        ...
        <div class="placeholder-card">
            <div class="card-header">
                ...
                <div>
                    ...
                    <div class="card-subtitle">{{ $classrooms->count() }} assigned</div>
                </div>
            </div>
        ...
        <div class="placeholder-card">
            <div class="card-header">
                ...
                <div>
                    ...
                    <div class="card-subtitle">{{ now()->format('l') }}&middot; <a href="{{ route('teacher.schedule') }}" style="color: #4F46E5; text-decoration: none;">View full week</a></div>
                </div>
            </div>
        ...
        <div class="placeholder-card">
            <div class="card-header">
                ...
                <div>
                    <div class="card-title">Subject Assignments</div>
                    <div class="card-subtitle">{{ $assignments->count() }} assigned</div>
                </div>
            </div>
