<x-layouts.app pageTitle="Teacher Dashboard">
    ...
    <div class="welcome-banner">
        <div style="position: relative; z-index: 1;">
            ...
            <p style="font-size: 14px; color: #c7d2fe;">
                Ready for today's classes? Here's your teaching overview.
            </p>
        </div>
    </div>
    ...
    <a href="{{ route('teacher.schedule') }}" class="schedule-card-link">
        <div>
            <div style="font-size: 13px; opacity: 0.8; margin-bottom: 4px;">Today's Schedule</div>
            <div style="font-size: 18px; font-weight: 700;">{{ $todaySlots->count() }} classes today</div>
        </div>
    ...
    <div class="placeholder-grid">
        {{-- My Classes --}}
        <x-dashboard.card title="My Classes" :subtitle="$classrooms->count() . ' assigned'" iconBg="#eff6ff">
            <x-slot:icon>
        ...
        {{-- My Schedule --}}
        <x-dashboard.card title="Today's Schedule" iconBg="#ecfdf5">
            <x-slot:icon>
                <svg width="20" height="20" fill="none" stroke="#10b981" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
            </x-slot:icon>
            <x-slot:subtitle>{{ now()->format('l') }} &middot; <a href="{{ route('teacher.schedule') }}" style="color: #4F46E5; text-decoration: none;">View full week</a></x-slot:subtitle>
        ...
        <x-dashboard.card title="Subject Assignments" :subtitle="$assignments->count() . ' assigned'" iconBg="#fffbeb">
            <x-slot:icon>
        ...
        {{-- Attendance Entry --}}
        <x-dashboard.card title="Attendance Entry" subtitle="Mark today's attendance" iconBg="#eef2ff">
            <x-slot:icon>
