    ...
    <div class="main-content">
        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    ...
                    @if(session('impersonate_role'))
                        <div class="breadcrumb" style="color: #d97706; font-size: 11px; margin-top: 2px;">
                            <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            Viewing as: {{ ucfirst(session('impersonate_role')) }}
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="topbar-right">
                @if(session('impersonate_role'))
                    <form action="{{ route('impersonate.stop') }}" method="POST" style="margin: 0;">
                        @csrf
                        <button type="submit" style="padding: 6px 12px; border-radius: 8px; background: #fef3c7; border: 1px solid #fcd34d; color: #92400e; font-size: 12px; font-weight: 600; cursor: pointer; font-family: 'DM Sans', sans-serif;">
                            Stop Impersonating
                        </button>
                    </form>
                @endif
